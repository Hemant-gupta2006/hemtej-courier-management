        ...
        <div className="backdrop-blur-xl bg-white/40 dark:bg-slate-900/40 border border-white/40 dark:border-white/10 shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] rounded-3xl p-8 rounded-2xl relative overflow-hidden">
          <div className="flex flex-col items-center mb-8 space-y-4">
            <motion.div 
              ...
              className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-tr from-blue-600 to-purple-600 shadow-lg"
            >
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Join our platform to start managing couriers
              </p>
            </div>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2 relative">
                <Label htmlFor="name" className="text-slate-700 dark:text-slate-300 ml-1">Name</Label>
